...
# main benefits is to minimize the duplication of code


# example
# any class in python is inherited form the object class
...
class CustomerClass(PersonClass):
    ...
    def print_customer_phone(self, customer_phone):
        print("Customer " + self.first_name + " " +
              self.last_name + " phone is :" + customer_phone)
...
def main():
    ...
    # check if an employee is an employee
